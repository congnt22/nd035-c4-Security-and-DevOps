...
public class SecurityTests {
    ...
    public void setup() {
        ...
        userRequest.setUsername("CongNguyen");
        userRequest.setPassword("password");
        userRequest.setConfirmPassword("password");

        cartRequest = new ModifyCartRequest();
        cartRequest.setUsername("CongNguyen");
    ...
    public void testLogin() throws Exception {
        ...
        mvc.perform(
                MockMvcRequestBuilders.post("/login").content("{\"username\":\"CongNguyen\", \"password\":\"password\"}")
                        .contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk()).andReturn();
        // Login with wrong credential
        mvc.perform(
                MockMvcRequestBuilders.post("/login").content("{\"username\":\"CongNguyen\", \"password\":\"wrongPassword\"}")
                        .contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON))
